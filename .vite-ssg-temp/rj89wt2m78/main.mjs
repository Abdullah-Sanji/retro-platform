...
import { _ as _export_sfc, p as provideNotification, e as useSafeUser, d as useFullPermission, C as ConvexClientKey } from "./assets/marketing-1kkeCTA4.js";
...
import { _ as _sfc_main$4 } from "./assets/retro-DUribbta.js";
...
const routes = [
    ...
    children: [
      {
        path: "",
        name: "home",
        component: () => import("./assets/marketing-1kkeCTA4.js").then((n) => n.H),
        meta: {
      ...
      },
      {
        path: "features",
        name: "features",
        component: () => import("./assets/marketing-1kkeCTA4.js").then((n) => n.F),
        meta: {
      ...
      },
      {
        path: "pricing",
        name: "pricing",
        component: () => import("./assets/marketing-1kkeCTA4.js").then((n) => n.P),
        meta: {
    ...
    children: [
      {
        path: "create",
        name: "create-session",
        component: () => import("./assets/app-DtGTsZNN.js").then((n) => n.S)
      },
      {
        path: "board/:sessionId",
        name: "board",
        component: () => import("./assets/app-DtGTsZNN.js").then((n) => n.R),
        props: true
      },
  ...
  // Dashboard (requires auth)
  {
    path: "/dashboard",
    name: "dashboard",
    component: () => import("./assets/DashboardPage-nDvfDMn3.js")
  }
];
